...
const audienceData = new Map([
  [0, require('./data/audience1-expanded.json')],
  [1, require('./data/audience2-expanded.json')],
  [2, { audience: [] }],
]);

const bandwidthData = new Map([
  [0, require('./data/bandwidth1-expanded.json')],
  [1, require('./data/bandwidth2-expanded.json')],
  [2, { cdn: [], p2p: [] }],
]);
